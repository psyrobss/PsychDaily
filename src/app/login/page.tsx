      ...
      <Card className="w-full max-w-md shadow-xl border-primary/10">
        <CardHeader className="text-center">
          ...
          <CardDescription className="font-sans text-muted-foreground pt-2">
            A funcionalidade de login estará disponível em breve. Agradecemos a sua paciência!
          </CardDescription>
        </CardHeader>
        <CardContent className="text-center">
          <p className="text-foreground/80">
            Enquanto isso, todo o nosso conteúdo está disponível gratuitamente para você explorar.
          </p>
        </CardContent>
