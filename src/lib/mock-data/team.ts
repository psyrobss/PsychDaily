...
import type { MembroEquipeEditorial } from '../types';

export let equipeEditorial: MembroEquipeEditorial[] = [
  {
    id: 'dra-alma-compassiva',
    nome: 'Dra. Helena Fictícia Alcantara',
    persona: 'Dra. Alma Compassiva',
    cargo: 'Editora-Chefe de Narrativas e Conexões Humanas',
    biografia: [
      'Dra. Helena Fictícia Alcantara, carinhosamente conhecida como Dra. Alma Compassiva, ancora sua prática em uma visão de mundo onde a cura emerge da conexão humana autêntica e da coragem intrínseca de cada indivíduo em enfrentar suas próprias vulnerabilidades. Para ela, a psicologia transcende a mera ciência, tornando-se uma arte delicada de tecer compaixão no tecido social, iluminando caminhos mesmo nas mais densas sombras do sofrimento.',
      'Sua perspectiva é profundamente humanista e social, priorizando a escuta empática radical e a validação incondicional da experiência subjetiva. Critica veementemente abordagens excessivamente patologizantes que reduzem o ser humano a um conjunto de sintomas, defendendo uma psicologia que acolhe a complexidade e a singularidade de cada história de vida.',
  ...
  {
    id: 'dr-analitico',
    nome: 'Dr. Arthur Fictício Mendes Neto',
    persona: 'Dr. Analítico',
    cargo: 'Diretor de Pesquisa e Insights Científicos',
    biografia: [
      'Dr. Arthur Fictício Mendes Neto, conhecido no meio acadêmico e entre seus leitores como Dr. Analítico, tem como visão de mundo a premissa de que a ciência psicológica, quando conduzida com rigor e ética, é uma ferramenta indispensável para a compreensão objetiva do comportamento humano e para o desenvolvimento de intervenções eficazes e baseadas em evidências sólidas. Ele defende com paixão o método científico, a clareza conceitual e a comunicação transparente dos achados da pesquisa.',
      'Sua perspectiva é predominantemente cognitivo-comportamental, fortemente ancorada na neurociência e na análise de dados quantitativos e qualitativos. É um crítico assertivo de abordagens pseudocientíficas ou aquelas que carecem de fundamentação empírica robusta, acreditando que a psicologia deve se pautar pela busca da verdade, mesmo que complexa e multifacetada.',
  ...
  {
    id: 'prof-historiadora',
    nome: 'Prof. Dra. Isadora Fictícia Valente',
    persona: 'Prof. Historiadora',
    cargo: 'Curadora de Contextos e Perspectivas Críticas',
    biografia: [
      'A Prof. Dra. Isadora Fictícia Valente, ou simplesmente Prof. Historiadora para os leitores do PsychDaily, acredita que a psicologia, como qualquer campo do saber, é uma construção sócio-histórica. Sua visão de mundo é pautada pela necessidade de uma análise crítica das narrativas dominantes, questionando quem as construiu, com quais interesses e quais vozes foram silenciadas no processo. Ela defende o resgate de saberes ancestrais, populares e marginalizados como essencial para uma compreensão mais completa e justa da psique humana.',
      'Sua perspectiva é decolonial, crítica e profundamente influenciada pela psicologia social e pelos estudos culturais. Ela investiga as relações de poder que moldam o conhecimento psicológico e busca ativamente desconstruir visões eurocêntricas e universalistas que ignoram a diversidade das experiências humanas globais, especialmente as do Sul Global.',
  ...
  {
    id: 'psicologa-criativa',
    nome: 'Clarice Fictícia Arantes',
    persona: 'A Psicóloga Inventiva',
    cargo: 'Editora de Inovação e Formatos Interativos',
    biografia: [
      'Clarice Fictícia Arantes, conhecida por sua abordagem vibrante como A Psicóloga Inventiva, enxerga a psicologia não apenas como uma ciência, mas como uma arte viva, um campo fértil para a criatividade e a imaginação. Sua visão de mundo é de que o autoconhecimento e a cura emocional podem ser acessados através de múltiplos portais, sendo a expressão criativa um dos mais poderosos e universais.',
      'Com uma perspectiva humanista-existencial, Clarice tem uma forte inclinação para abordagens terapêuticas expressivas e narrativas. Ela defende apaixonadamente a ludicidade, a metáfora e a arte como ferramentas terapêuticas capazes de contornar as defesas do ego e alcançar camadas mais profundas da psique, promovendo insights e transformações que a linguagem puramente racional muitas vezes não consegue atingir.',
  ...
  {
    id: 'colunista-kai',
    nome: 'Kai Fictício Oliveira',
    persona: 'O Analista de Contextos',
    cargo: 'Colunista e Curador de Saberes Comunitários',
    biografia: [
      'Kai Fictício Oliveira, o perspicaz Analista de Contextos do PsychDaily, dedica seu trabalho a conectar a psicologia formal acadêmica com a imensa riqueza dos saberes comunitários, tradicionais e ancestrais, muitas vezes negligenciados pelas narrativas hegemônicas. Sua visão de mundo é de que a saúde mental é intrinsecamente coletiva e profundamente influenciada pelo contexto sociocultural, político e histórico de cada indivíduo e comunidade.',
      'Com uma perspectiva crítica e decolonial, Kai questiona ativamente as narrativas eurocêntricas dominantes na psicologia, buscando valorizar a oralidade, as práticas de cuidado coletivo e as diversas epistemologias do Sul Global. Ele acredita firmemente que a verdadeira saúde mental floresce em ambientes de justiça social, equidade e respeito à diversidade cultural e de experiências.',
  ...
  {
    id: 'jornalista-sofia',
    nome: 'Sofia Fictícia Almeida',
    persona: 'A Repórter da Psique',
    cargo: 'Jornalista de Investigações Psicológicas',
    biografia: [
      'Sofia Fictícia Almeida, A Repórter da Psique, é uma jornalista investigativa com um olhar aguçado para as nuances da mente humana e as complexas estruturas sociais que a influenciam. Sua visão de mundo é de que o conhecimento psicológico, quando comunicado com clareza, precisão e responsabilidade, pode ser uma ferramenta poderosa para o empoderamento individual e a transformação social. Ela acredita no jornalismo como um serviço público, capaz de desmistificar temas áridos e trazer à luz questões de saúde mental frequentemente negligenciadas ou estigmatizadas.',
      'Com uma perspectiva assertiva e investigativa, Sofia busca ir além da superfície, questionando fontes, analisando dados e ouvindo múltiplas vozes para construir reportagens que sejam não apenas informativas, mas que também provoquem o pensamento crítico e a reflexão. Seu compromisso com a ética jornalística é inabalável, assim como sua dedicação em traduzir jargões científicos em linguagem acessível a todos.',
  ...
  {
    id: 'dra-farmacologista-cautelosa',
    nome: 'Dra. Sofia Fictícia Klein',
    persona: 'A Farmacologista Cautelosa',
    cargo: 'Especialista em Psicofarmacologia Crítica',
    biografia: [
      'Dra. Sofia Fictícia Klein, nossa Farmacologista Cautelosa, aborda o universo da psicofarmacologia com um olhar que combina profundo conhecimento científico e uma aguçada consciência crítica. Sua visão de mundo é de que os medicamentos psiquiátricos, embora possam ser ferramentas valiosas e por vezes indispensáveis, devem ser compreendidos em sua totalidade – não apenas seus mecanismos de ação e benefícios, mas também seus riscos, efeitos colaterais, interações e o complexo contexto social e individual em que são prescritos e utilizados.',
      'Com uma perspectiva que prioriza a segurança do paciente e o consentimento verdadeiramente informado, Dra. Klein investiga a fundo as evidências científicas, questiona a medicalização excessiva de sofrimentos inerentes à condição humana e defende uma prática farmacológica ética e criteriosa. Ela acredita que a decisão pelo uso de psicofármacos deve ser sempre compartilhada, considerando alternativas terapêuticas não medicamentosas e o impacto global na qualidade de vida do indivíduo.',
  ...
  {
    id: 'dr-robson-savoldi',
    nome: 'Dr. Robson Savoldi',
  ...
  // Mantém Dr. Robson Savoldi por último
  if (a.id === 'dr-robson-savoldi') return 1; 
  if (b.id === 'dr-robson-savoldi') return -1;
  // Ordena os demais por nome
