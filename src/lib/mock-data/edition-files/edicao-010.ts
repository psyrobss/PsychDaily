...
export const conteudosEdicao010: Conteudo[] = [
  {
    id: 'editorial-010-paixao-paciencia',
    tipo: 'editorial',
  ...
  {
    id: 'aprofundado-010-agi-inteligencia-humana',
  ...
  {
    id: 'aprofundado-010-william-james-self',
    tipo: 'artigo_aprofundado',
  ...
  {
    id: 'aprofundado-010-sentido-trabalho',
    tipo: 'artigo_aprofundado',
  ...
  {
    id: 'tecnica-010-psicodrama',
    tipo: 'artigo_aprofundado', // Alterado de "técnica terapêutica" para "artigo aprofundado" para se encaixar melhor na seção
  ...
  {
    id: 'narrativa-010-relogios-descompassados',
  ...
  },
  {
    ...
    tags: ['nomear emoções', 'inteligência emocional', 'regulação emocional', 'autoconsciência', 'coluna', 'Daniel Siegel'],
    isPremium: false,
...
export const edicao010: Edicao = {
  edicao: "010",
  data: "2025-05-30", // Sexta-feira
  capa: {
    ...
    imageHint: "abstract brain", // Alterado de 'mind gears abstract thinking'
    credito_imagem: "Unsplash",
    links_manchetes: [
      { titulo: "AGI e Inteligência Humana: Uma Análise Epistemológica...", id_conteudo: "aprofundado-010-agi-inteligencia-humana" },
      { titulo: "O Self Multifacetado de William James: Consciência, Hábito...", id_conteudo: "aprofundado-010-william-james-self" },
      { titulo: "Além do Salário: Encontrando Propósito e Sentido no Trabalho...", id_conteudo: "aprofundado-010-sentido-trabalho" },
      { titulo: "Teatro da Alma: Introdução ao Psicodrama...", id_conteudo: "tecnica-010-psicodrama" }
    ]
  },
  secoes: [
    {
      ...
      tipo: "capa",
      conteudo_ids: [
        "editorial-010-paixao-paciencia",
        "aprofundado-010-agi-inteligencia-humana",
        "aprofundado-010-william-james-self",
        "aprofundado-010-sentido-trabalho"
      ]
    },
    {
    ...
    {
      nome_secao: "Explorando o Labirinto da Mente", // Agrupando os artigos de aprofundamento
    ...
    {
      nome_secao: "Ferramentas para o Bem-Estar: Técnicas Terapêuticas", // Mantendo a seção de técnicas
      tipo: "caderno_especial", // Para dar destaque
      conteudo_ids: ["tecnica-010-psicodrama"]
    },
    {
      nome_secao: "Contos da Psique",
      tipo: "narrativas",
      conteudo_ids: ["narrativa-010-relogios-descompassados"]
    },
    {
      nome_secao: "Palavras da Alma",
      tipo: "colunas",
      conteudo_ids: ["coluna-010-nomear-emocoes"]
    }
    // A seção de Psicofarmacologia e Crônica Terapêutica foram omitidas intencionalmente
    // para dar mais espaço aos artigos de aprofundamento solicitados para esta edição.
  ]
};
